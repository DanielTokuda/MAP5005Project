...
def cSIRres(S, I, BETA, GAMMA, t): # FIXME
    ...
    Ires = Iprime(t) - BETA*S(t)*I(t) + GAMMA*I(t)
...
def loss_func(params, Ts, Tc, sol, w=1):
    loss = 0
    loss += w*jnp.mean(MSE(cSIRres(lambda t: (forward(t, params['S'])[:, 0]), lambda t: (forward(t, params['I'])[:, 0]), params['beta'], params['gamma'], Tc), 0))
